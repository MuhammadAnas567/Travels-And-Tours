      ...
      <div className="w-full space-y-1.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              "flex h-11 w-full rounded-sm border bg-paper px-3 py-2 text-sm text-ink tabular-nums ring-offset-sand file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-ink-300 transition-[border-color,box-shadow] duration-[var(--duration-fast)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pine-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 read-only:bg-surface-sunken",
              prefixIcon && "pl-10",
              hasError
