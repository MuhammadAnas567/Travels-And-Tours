...
export function TestimonialsCarousel() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <figure className="rounded-md border border-line bg-paper px-6 py-10 sm:px-10 shadow-sm text-left">
        ...
        <blockquote className="mt-6">
          <p className="font-display text-xl sm:text-2xl font-semibold text-ink leading-snug max-w-[42ch]">
            &ldquo;{t.text}&rdquo;
          </p>
        </blockquote>
        <figcaption className="mt-6 flex flex-col items-start gap-0.5">
