  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8 prose prose-ocean">
      ...
      <div className="mt-8 space-y-4 text-gray-600">
        <p>By using UEB3 Tours, you agree to these terms. Please read them carefully.</p>
        ...
        <p>UEB3 Tours acts as an intermediary between travelers and local operators. We are not liable for events beyond our control.</p>
      </div>
    </div>
  );
}
