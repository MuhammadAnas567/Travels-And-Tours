...
export const metadata = infoMetadata(
  "Investor Relations",
  "Information for investors interested in Arreat Travels & Tours."
);
...
export default function InvestorsPage() {
  return (
    <InfoPage
      ...
      body={[
        "Arreat Travels & Tours is a privately held travel technology company. We share financial and product updates with investors on a scheduled basis.",
