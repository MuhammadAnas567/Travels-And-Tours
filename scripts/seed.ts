...
const DESTINATIONS = [
  { name: "Santorini", country: "Greece", category: "beach" as const, priceFrom: 189, popularity: 98, lat: 36.3932, lng: 25.4615, image: "https://images.unsplash.com/photo-1613395877344-13d4a8e0d49c?w=800", description: "Iconic white-washed villages and caldera sunsets." },
  ...
  { name: "Cape Town", country: "South Africa", category: "adventure" as const, priceFrom: 165, popularity: 82, lat: -33.9249, lng: 18.4241, image: "https://images.unsplash.com/photo-1580060839134-75a5edfa2f83?w=800", description: "Table Mountain, vineyards, and coastal drives." },
  ...
  { name: "Iceland", country: "Iceland", category: "adventure" as const, priceFrom: 290, popularity: 80, lat: 64.9631, lng: -19.0208, image: "https://images.unsplash.com/photo-1531168556467-80aace7d69bd?w=800", description: "Northern lights, geysers, and dramatic landscapes." },
...
const AIRLINES = [
  { name: "Emirates", logo: "https://images.unsplash.com/photo-1436491865332-7a61a4dc4b40?w=100" },
  { name: "Qatar Airways", logo: "https://images.unsplash.com/photo-1436491865332-7a61a4dc4b40?w=100" },
  { name: "Singapore Airlines", logo: "https://images.unsplash.com/photo-1436491865332-7a61a4dc4b40?w=100" },
  { name: "Lufthansa", logo: "https://images.unsplash.com/photo-1436491865332-7a61a4dc4b40?w=100" },
  { name: "British Airways", logo: "https://images.unsplash.com/photo-1436491865332-7a61a4dc4b40?w=100" },
];
